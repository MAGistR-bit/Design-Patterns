...
| 5 |               Одиночка               |                                                                                                                          **_Паттерн Одиночка_** гарантирует, что класс имеет только один экземпляр, и предоставляет глобальную точку доступа к этому экземпляру.                                                                                                                           |     [Заметки к паттерну "Одиночка"](src/main/java/singleton/Chapter5.md)      |                  Source code                   |                                             <img src="src/main/java/singleton/diagram/Singleton-Diagram.png">                                              |
___
