...
Этот репозиторий посвящен шаблонам проектирования (design patterns). 
Рассматривается 2-е издание книги **"Head First Design Patters"**.
Книга будет полезна тем, кто только начинает свой путь в освоении паттернов проектирования.

Исходный код написан на языке программирования Java.
...
Надеюсь, что информация, представленная в репозитории,
будет Вам полезна.
**_Успехов в изучении!_**
